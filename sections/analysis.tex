...
The early joint-training control in Figure~\ref{fig:fourarm} complements the prompt-swap experiment. With shared $t=\tau^2$ inference, the random-joint arm reaches 3.98\%, 7.77\%, and 8.61\% at epochs 2, 4, and 6, versus 12.40\%, 26.61\%, and 31.01\% for teacher-prompt training. Within this six-epoch budget, supplying a stable contextual prompt representation is substantially more effective than learning both components from the beginning.
