...
\begin{enumerate}
    ...
    \emph{[Section~X: training recipe; Section~\ref{sec:headlineresults} and Tables~\ref{tab:headlinecomparison}--\ref{tab:headlinelownfe}: mathematical reasoning; Table~Y: coding results.]}
