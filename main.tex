...
We apply Eq.~\eqref{eq:methodinterpolant} to the learned answer latents with $\sigma=2$. One time is drawn per training example and shared across its tokens and layer groups. A bidirectional Transformer jointly processes the clean prompt and noisy answer.
